...
---
<!-- AUTO-GENERATED from .claude/commands/reply-comments.md by pipeline/sync_harness.py — edit the SOURCE under .claude/, then re-run `python3 pipeline/sync_harness.py sync`. Do not edit this file by hand. -->
